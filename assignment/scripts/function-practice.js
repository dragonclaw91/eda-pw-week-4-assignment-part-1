...
console.log('addNumbers test',addNumbers(2,3))
...
function multiply(a,b){
  //the function isn't returning a * b by adding the word return in front of a * b it works fine.
  // should be return a * b not a * b
  a * b
}
